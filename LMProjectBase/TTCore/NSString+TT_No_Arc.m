//
//  NSString+TT_No_Arc.m
//  TT
//
//  Created by Andrzej Auchimowicz on 15/10/2013.
//  Copyright (c) 2013 Transition Technologies. All rights reserved.
//
//  Uses HTML escape/unescape code from GTM (Google Toolbox for Mac) library.
//
...
@implementation NSString(TT_No_Arc)
...
- (NSString *)gtm_stringByEscapingHTMLUsingTable:(HTMLEscapeMap*)table
    ...
    if (!buffer || !data2) {
        // COV_NF_START
        ERROR(@"Unable to allocate buffer or data2");
        return nil;
        // COV_NF_END
    }
